    ...
    <div class="container">
      ...
      <div class="jumbotron" style="color:#FFFFFF" >
       ...
       <h2 class="lead"><span style="color:#c0150d">S</span>istema <span style="color:#c0150d">P</span>aliativo <span style="color:#c0150d">E</span>specializado 
        ...
        <form role="form"class="col-md-4 col-md-offset-4" style="margin-top:-70px">
		  <div class="form-group">
			<label for="login">Solicitar novo password</label>
			<input type="text" class="form-control" id="login" name="login" placeholder="Digite seu login" maxlength="25" >
		  </div>
		  <a type="button" class="btn btn-success btn-sm pull-right" href="#" >Solicitar</a>
		</form>
		</div>
		<br />
		<div class="row">
		<form role="form"class="col-md-4 col-md-offset-4">
		  <div class="form-group ">
			<label for="password">Solicitar novo login</label>
			<input type="e-mail" class="form-control" id="eMail"  name="eMail" placeholder="Digite seu e-mail cadastrado" maxlength="45">
		  </div>
		 <a type="button" class="btn btn-success btn-sm pull-right" href="#" >Solicitar</a>
		</form>
        </div>
